...
public class Main {
	...
	public static void main(String[] args) {
		...
		ejer9_basura.rellenarTodo(aeropuertos, aviones, pasajeros, comandantes);
		opciones(pasajeros, comandantes, aviones, aeropuertos);
		...
		do {
			...
			case 0:
				...
				if (add > numAdd) {
					...
					ejer9_basura.rellenarPeticion(add, aeropuertos, aviones, pasajeros, comandantes);
					numAdd -= add;
