...
public class Main {
	...
	private static int menu() {
		...
		System.out.println(
				"15. Crear archivo con los equipos que hayan perdido por mas de 40 puntos y no se repiten los equipos"
						+ "\n16. Eliminar jugadores desde archivo" + "\n17. Modificar los datos de un jugador"
						+ "\n18. Cambiar de equipo a jugador");
