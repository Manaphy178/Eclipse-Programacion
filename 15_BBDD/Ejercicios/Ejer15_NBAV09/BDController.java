...
public class BDController {
	...
	/*
	 * Esto es de las ultimas cosas, implementar en todos
	 */

	public ArrayList<String> temporadas() {
	...
	public ArrayList<Partido> partidos(String temporada) {
		ArrayList<Partido> partidos = new ArrayList<Partido>();
		String sql = "SELECT * FROM partidos WHERE temporada = '" + temporada + "'";
		try {
			Statement mySt = con.createStatement();
			ResultSet rs = mySt.executeQuery(sql);
			while (rs.next()) {
	...
	public ArrayList<Integer> codigosJugM(String nomEq) {
		ArrayList<Integer> codigos = new ArrayList<Integer>();
		String sql = "SELECT Nombre FROM jugador WHERE Nombre_equipo = '" + nomEq + "'";
		try {
			Statement mySt = con.createStatement();
			ResultSet rs = mySt.executeQuery(sql);
			while (rs.next()) {
