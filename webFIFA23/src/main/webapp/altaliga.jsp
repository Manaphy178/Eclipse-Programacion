							...
							<!-- Content -->
								...
								<form action="./operaciones.jsp?tipo=altaliga" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre de la liga" style="width:450px" maxlength="30" />
										</div>
										
										
										<div class="">
											<input type="text" name="pais" id="pais" placeholder="Pais de la liga" maxlength="30" />
										</div>
