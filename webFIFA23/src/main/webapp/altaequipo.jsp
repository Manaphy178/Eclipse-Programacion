							...
							<!-- Content -->
								...
								<form action="./operaciones.jsp?tipo=altaequipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del equipo" style="width:450px" maxlength="50" />
										</div>
										
										<div class="">
											<select name="liga" id="liga" required style="width: 450px;" is="ms-dropdown" data-child-height="450">
												<option value="" data-description="">Selecciona una liga</option>
											<%for(Liga l : bd.todasLigas()){ %>
												<option value="<%=l.getCod()%>" data-image="./images/ligas/<%=l.getCod()%>.png"><%=l.getNombre() %></option>
												<%} %>
											</select>
