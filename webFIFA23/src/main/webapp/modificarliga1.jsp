					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Selecciona la liga que quieres modificar</h3>
								<form action="./modificarliga2.jsp" method="post">
									<div class="row gtr-50">
										<div class="">
											<select name="liga" id="liga">
														<%for (Liga l: bd.todasLigas()){ %>
												<option value="<%=l.getCod()%>"><%=l.getNombre() %></option>
												<%} %>
											</select>
										</div>
									</div>
									...
									<div style="padding-top:22px;">
											<ul class="actions">
												<li><input type="submit" class="button alt" value="Seleccionar" /></li>
