						...
						<div id="content">
							...
							<!-- Content -->
								...
								<table class="alt">
									...
									<tbody>
									<% for (Liga l : bd.todasLigas()){
										%>
										<tr>
											<td width='60' rowspan="2"><a href="liga.jsp?codL=<%=l.getCod()%>"><img src="./images/ligas/<%=l.getCod()%>.png" style="width: 64px;height: 64px;min-width: 30%;background-position: center;"></a></td>
											<td width='300' colspan="3" style="padding-left: 15px;color: red;font-size: 1.25rem;"><a href="liga.jsp?codL=<%=l.getCod()%>"><%=l.getNombre() %> </a></td>
											<% for (Equipo e : bd.dameEquiposLiga(l.getCod())){
												int codEquipo = e.getCodE();%>  
											<td rowspan="2" width='60' style="text-align: center;"><a href="equipo.jsp?codE=<%=e.getCodE()%>"><img src="./images/equipos/<%=e.getCodE() %>.png" style="width:40px;height:40px;background-position:center" title="<%=e.getNombre()%>"></a> </td>	
												<%} %>								
										</tr>
										<tr>
										  
										  <td width='50' style="text-align: left; padding-left: 14px;"><img src="./images/paises/<%=l.getPais()%>.png" style="width:40px;height:25px;background-position:center" alt=""></td>
										  <td width='205'></td>
										</tr>
