...
<%
	...
	int cod_l =Integer.parseInt( request.getParameter("liga"));
	Liga liga = bd.dameLiga(cod_l);
					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="./operaciones.jsp?tipo=modificarliga&modificar=<%=liga.getCod() %>" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del equipo" style="width:450px" maxlength="50" value="<%=liga.getNombre()%>"/>
										</div>
										
										<div class="">
											<input type="text" name="pais" id="pais" placeholder="Pais de la liga" maxlength="30" value="<%=liga.getPais()%>"/>
										</div>
