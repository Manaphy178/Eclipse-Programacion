						...
						<div id="content">
							...
							<!-- Content -->
								...
								<table class="alt">
									...
									<tbody>
									<% for (Equipo e : bd.dameEquiposLiga(l.getCod())){ 
									%>
										<tr>
											<td width='60' rowspan="2"><a href="equipo.jsp?codE=<%=e.getCodE()%>"><img src="./images/equipos/<%=e.getCodE()%>.png" style="width: 64px;height: 64px;min-width: 30%;background-position: center;"></a></td>
											<td width='300' colspan="3" style="padding-left: 15px;color: red;font-size: 1.25rem;"><a href="equipo.jsp?codE=<%=e.getCodE()%>"><%=e.getNombre() %></a> </td>
											  <%for (Jugador j : bd.dameJugadoresEquipos(e.getCodE())){ %>
											<td rowspan="2" width='60' style="text-align: center;"><a href="jugador.jsp?codJ=<%=j.getCodJ() %>"><img src="./images/jugadores/<%=j.getCodJ() %>.png" style="width:60px;height:60px;background-position:center" title="<%=j.getNombre()%>"> </a></td>	
												<%} %>					
										</tr>
										<tr>
										
										<td width='50' style="text-align: center;"><img src="./images/paises/<%=l.getPais()%>.png" alt=""style="width:40px;height:25px;background-position:center"></td>
										  <td width='230'><a href="ligas.jsp"><img src="./images/ligas/<%=l.getCod() %>.png" alt="" style="width:40px;height:40px; background-position:center;"></a></td>
										</tr>
