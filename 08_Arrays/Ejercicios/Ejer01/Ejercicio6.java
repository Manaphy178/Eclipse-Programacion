...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("¿Sabes que? Te vas a quedar sin regalos por tonto >:)\r");
		for (int i = 1; i < 9; i++) {
			gifts[i - 1] = "Te quedas con nada por feo, me caes mal niño";
			System.out.println(i + ". " + gifts[i - 1]);
		}
		System.out.println("");
		System.out.println("Y tienes suerte que no te envie a un camello para que te escupa");
	}
}
